...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_PROGRAMMERS, CRED_WATANABE, CRED_MASUDA, CRED_TAMADA, CRED_TEXT_MON
	db CRED_CHAR_DESIGN, CRED_SUGIMORI, CRED_NISHIDA, CRED_TEXT_FADE_MON
	db CRED_MUSIC, CRED_MASUDA, CRED_TEXT_FADE
	db CRED_SOUND_EFFECTS, CRED_MASUDA, CRED_TEXT_MON
	db CRED_GAME_DESIGN, CRED_TAJIRI, CRED_TEXT_FADE_MON
	db CRED_MONSTER_DESIGN, CRED_SUGIMORI, CRED_NISHIDA, CRED_FUJIWARA, CRED_TEXT_FADE
	...
	db CRED_GAME_SCENE, CRED_TANIGUCHI, CRED_NONOMURA, CRED_JINNAI, CRED_TEXT_MON
	...
	db CRED_TRANS, CRED_CISNEROS, CRED_TEXT_FADE
	db CRED_CORR, CRED_AINA, CRED_ANDREU, CRED_EMILIO,CRED_TEXT_MON
